...
<p align="center">
  ...
  <a href="https://github.com/mayTermux/awesomeshot/releases"><img src="https://img.shields.io/github/release/mayTermux/Axiom.svg"></a>
</p>
...
[![Axiom Thumbnail](https://user-images.githubusercontent.com/64394320/170211137-554dfd78-8424-4699-876c-7483b45de068.png)](https://www.youtube.com/watch?v=sYkNxK_44Zg "Axiom - Installation")
...
> - [Termux:API must be installed](https://f-droid.org/en/packages/com.termux.api/) Axiom use API command from Termux:API like fetch `termux-battery-status`
...
```bash
git clone --depth=1 https://github.com/mayTermux/Axiom.git
```
